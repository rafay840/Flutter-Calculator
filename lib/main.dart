...
class _MyHomePageState extends State<MyHomePage> {
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: GoogleFonts.lato(
            textStyle: TextStyle(color: Colors.gray, letterSpacing: 8),
          ),
        ),
      ),
      body: Column(
  ...
  Widget _button(String value, Color buttoncolor, Color fontcolor) {
    return InkWell(
      ...
      child: Container(
          ...
          child: Center(
            child: Text(
              value,
              style: GoogleFonts.lato(
                textStyle: TextStyle(fontSize: 30, color: fontcolor),
              ),
            ),
          ),
          decoration:
